...
class VidMag():
    ...
    def magnify_motion(self,video_tensor,fps,low=.4,high=1.5,levels=3,amplification=5):
    ...
    def save_video(frames, output_path, fps):
            ...
            video_writer = cv2.VideoWriter(output_path, cv2.VideoWriter_fourcc(*'MJPG'), fps, (frames[0].shape[1], frames[0].shape[0]))
    ...
    def mainLoop(self):
        ...
        print(f2.shape)
        # Save frames to a video file in AVI format
        self.save_video([f2], 'output.avi', 10)
